...
namespace {
    ...
    $cache = '\\community\\videolibrary\\components\\RemoteCache';
    ...
    $client = new \community\videolibrary\components\PeerTubeClient();
    ...
    $transcriptService = \community\videolibrary\components\TranscriptService::class;
    ...
    $liveError = \community\videolibrary\components\LiveError::class;
    ...
    $thumb = '\\community\\videolibrary\\components\\ThumbnailCache';
    ...
    $controller = new \community\videolibrary\controllers\MediaController();
    $controller->contentContainer = (object)['moduleManager'=>new class { function isEnabled($id) { return true; } }];
    \community\videolibrary\models\Media::$item = new \community\videolibrary\models\Media();
    ...
    \community\videolibrary\models\Media::$item->allowed = true;
    check($controller->actionThumbnail(1) !== '', 'Authorized cached image delivered');
    \community\videolibrary\models\Media::$item = null; fails(fn()=>$controller->actionThumbnail(1), 'Deleted record rejected');
